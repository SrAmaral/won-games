...
const Index = (props: GameTemplateProps) => <Game {...props}></Game>
  ...
  return {
    props: {
      ...
      gameInfo: {
        ...
        price: '59.00',
        description:
          'Cyberpunk 2077 is an ope-world, action-adventure story set in Nigth City, a megalopolis obsed wiht Power, glamour and body modification. You pllay as V, a mercenary outlaw going after a end-of-a-kind implat that is the key to immortality'
      },
      gallery: galleryMock,
