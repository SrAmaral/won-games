...
describe('<PaymentOptions />', () => {
  it('should render the saved card options and the add new card button', () => {
    ...
    expect(screen.getByLabelText(/6325/)).toBeInTheDocument()
    expect(screen.getByLabelText(/6326/)).toBeInTheDocument()
  ...
  it('should handle select card when clicking on the label', async () => {
    ...
    userEvent.click(screen.getByLabelText(/6325/))
    await waitFor(() => {
      expect(screen.getByRole('radio', { name: /6325/ })).toBeChecked()
    })
  })
